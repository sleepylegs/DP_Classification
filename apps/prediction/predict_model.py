    ...
    def batch_predict_from_model(self):
        ...
        *   none:
        ...
        try:
            ...
            #cluster selection
            clusters = kmeans.predict(self.X.drop(['id'],axis=1))
            ...
            for i in clusters:
                ...
                cluster_data_new = cluster_data.drop(['id','clusters'], axis=1)
                ...
                result = pd.DataFrame({"ID": cluster_data['id'],"Prediction": y_predicted})
